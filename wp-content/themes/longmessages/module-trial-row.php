...
<table border="0" dir="rtl" class="trial_form form_row">
	<tbody>
		<tr>
			...
			<td>
				<input type="hidden" name="fields[מקור]" size="14" dir="rtl" placeholder="" />
				<input type="hidden" name="fields[טופס]" size="14" dir="rtl" value="<?php echo $form_id; ?>" placeholder="" />
